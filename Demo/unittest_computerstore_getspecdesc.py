...
import requests
import unittest
from CrawlerComputerstore import get_spec_desc
...
class TestUM(unittest.TestCase):
    ...
    def test_spec_desc(self):
        for item_container in soup.findAll('div', {'class': 'product_container'}):
            self.assertIsNotNone(get_spec_desc("product_container", item_container, soup))
        for item_container in soup.findAll('div', {'class': 'product-page'}):
            self.assertIsNotNone(get_spec_desc("product-page", item_container, soup))
