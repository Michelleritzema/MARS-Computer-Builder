...
$(function() {
    $( "#processor_clockingspeed" ).slider({
        range: true, min: 2900, max: 4700, step: 150, values: [ processor_clocking0, processor_clocking1 ],
        slide: function( event, ui ) {
            $( "#speed" ).val( + ui.values[ 0 ] + " MHz tot " + ui.values[ 1 ] + " MHz" );
    ...
    " MHz tot " + $( "#processor_clockingspeed" ).slider( "values", 1 ) + "MHz" );
});

// Processor - Prijs
$(function() {
    $( "#processor_price" ).slider({
        range: true, min: 0, max: 1000, step: 100, values: [ processor_price0, processor_price1 ],
        slide: function( event, ui ) {
    ...
    " tot €" + $( "#processor_price" ).slider( "values", 1 ));
});

// Videokaart - Prijs
$(function() {
    $( "#videocard_price" ).slider({
        range: true, min: 0, max: 600, step: 100, values: [ videocard_price0, videocard_price1 ],
        slide: function( event, ui ) {
            $( "#amount_GPU_prijs" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#videocard_price" ).slider( "values", 1 ));
});

// Videokaart - Geheugen
$(function() {
    $( "#videocard_memory" ).slider({
        range: true, min: 500, max: 8200, step: 513, values: [ videocard_memoryMb0, videocard_memoryMb1 ],
        slide: function( event, ui ) {
            $( "#amount_GPU_geheugen" ).val( + ui.values[ 0 ] + " MB tot " + ui.values[ 1 ] + " MB" );
    ...
    " MB tot " + $( "#videocard_memory" ).slider( "values", 1 ) + "MB" );
});

// RAM - Prijs
$(function() {
    $( "#ram_price" ).slider({
        range: true, min: 0, max: 500, step: 50, values: [ ram_price0, ram_price1 ],
        slide: function( event, ui ) {
            $( "#amount_ram" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#ram_price" ).slider( "values", 1 ));
});

// Moederbord - Prijs
$(function() {
    $( "#motherboard_price" ).slider({
        range: true, min: 0, max: 500, step: 50, values: [ motherboard_price0, motherboard_price1 ],
        slide: function( event, ui ) {
            $( "#amount_moederbord" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#motherboard_price" ).slider( "values", 1 ));
});

// Moederbord - Poorten
$(function() {
    $( "#motherboard_ports" ).slider({
        range: "min", min: 0, max: 14, value: Usb_port0,
        slide: function( event, ui ) {
...
$(function() {
    $( "#motherboard_sata300" ).slider({
        range: "min", min: 0, max: 6, value: motherboard_sata300connection0,
        slide: function( event, ui ) {
...
$(function() {
    $( "#motherboard_sata600" ).slider({
        range: "min", min: 0, max: 10, value: motherboard_sata600connection0,
        slide: function( event, ui ) {
...
$(function() {
    $( "#slider_harddiskdrive_price" ).slider({
        range: true, min: 0, max: 400, step: 50, values: [ harddiskdrive_price0, harddiskdrive_price1 ],
        slide: function( event, ui ) {
            $( "#amount_hdd" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#slider_harddiskdrive_price" ).slider( "values", 1 ));
});

// SSD - Prijs
$(function() {
    $( "#ssd_price" ).slider({
        range: true, min: 0, max: 600, step: 50, values: [ ssd_price0, ssd_price1 ],
        slide: function( event, ui ) {
            $( "#amount_ssd" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#ssd_price" ).slider( "values", 1 ));
});

// SSD = schrijfsnelheid
$(function() {
    $( "#ssd_writespeed" ).slider({
        range: true, min: 100, max: 600, step: 50, values: [ ssd_writespeed0, ssd_writespeed1 ],
        slide: function( event, ui ) {
            $( "#amount_ssd_schrijf" ).val(  + ui.values[ 0 ] + " tot " + ui.values[ 1 ] + "MB/s"  );
    ...
    " tot " + $( "#ssd_writespeed" ).slider( "values", 1 ) + "MB/s");
});

// SSD - leessnelheid
$(function() {
    $( "#ssd_readspeed" ).slider({
        range: true, min: 410, max: 550, step: 20, values: [ ssd_readspeed0, ssd_readspeed1 ],
        slide: function( event, ui ) {
            $( "#amount_ssd_lees" ).val(  + ui.values[ 0 ] + " tot " + ui.values[ 1 ] + "MB/s"  );
    ...
    " tot " + $( "#ssd_readspeed" ).slider( "values", 1 ) + "MB/s");
});

// Behuizing - Prijs
$(function() {
    $( "#casing_price" ).slider({
        range: true, min: 30, max: 150, step: 20, values: [ casing_Price0, casing_Price1 ],
        slide: function( event, ui ) {
            $( "#amount_behuizing" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#casing_price" ).slider( "values", 1 ));
});

// Behuizing - 3,5'' Bays
$(function() {
    $( "#casing_35bays" ).slider({
        range: true, min: 2, max: 13, values: [ casing_HDD_0, casing_HDD_1 ],
        slide: function( event, ui ) {
...
$(function() {
    $( "#casing_25bays" ).slider({
        range: true, min: 0, max: 18, values: [ casing_HDD_SSD_0, casing_HDD_SSD_1 ],
        slide: function( event, ui ) {
...
$(function() {
    $( "#casing_525bays" ).slider({
        range: true, min: 0, max: 9, values: [ casing_Bayss0, casing_Bayss1 ],
        slide: function( event, ui ) {
...
$(function() {
    $( "#casing_ports" ).slider({
        range: true, min: 2, max: 11, values: [ casing_expansion_0, casing_expansion_1 ],
        slide: function( event, ui ) {
...
$(function() {
    $( "#pci_price" ).slider({
        range: true, min: 0, max: 80, step: 20, values: [ pci_price0, pci_price1 ],
        slide: function( event, ui ) {
    ...
    " tot €" + $( "#pci_price" ).slider( "values", 1 ));
});

// Geluidskaart - Prijs
$(function() {
    $( "#soundcard_price" ).slider({
        range: true, min: 0, max: 200, step: 20, values: [ soundcard_price0, soundcard_price1 ],
        slide: function( event, ui ) {
    ...
    " tot €" + $( "#soundcard_price" ).slider( "values", 1 ));
});

// Blu-ray & DVD - Prijs
$(function() {
    $( "#blyraydvd_price" ).slider({
        range: true, min: 0, max: 120, step: 20, values: [ BluRayDVD_price0, BluRayDVD_price1 ],
        slide: function( event, ui ) {
    ...
    " tot €" + $( "#blyraydvd_price" ).slider( "values", 1 ));
});
...
$(function() {
    $( "#slider_processorcooler_price" ).slider({
        ...
        slide: function( event, ui ) {
            $( "#amount_koeler" ).val( "€" + ui.values[ 0 ] + " tot €" + ui.values[ 1 ]  );
    ...
    " tot €" + $( "#slider_processorcooler_price" ).slider( "values", 1 ));
});
...
$(function() {
    $( "#slider_processorcooler_rotation" ).slider({
        ...
        slide: function( event, ui ) {
            $( "#koeler_rotatie" ).val(  ui.values[ 0 ] + " tot " + ui.values[ 1 ]  );
    ...
    " tot " + $( "#slider_processorcooler_rotation" ).slider( "values", 1 ));
});